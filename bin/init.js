...
function start(isCover) {
  ...
  */
  ...
  fs.createReadStream(path.resolve(__dirname, "../template/release.js")).pipe(fs.createWriteStream(resolveApp("./scripts/release.js")));
  fs.createReadStream(path.resolve(__dirname, "../template/pushDev.js")).pipe(fs.createWriteStream(resolveApp("./scripts/pushDev.js")));
};
